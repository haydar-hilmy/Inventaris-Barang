    ...
    <div class="all-content">
        ...
        <nav id="nav">
            ...
            <div class="nav-button">
                ...
                <a class="active-btn" href="barang_keluar.php">
        ...
        <div class="content">
            ...
            <div class="table-pack">
                ...
                <table>
                    ...
                    <tbody>
                        <?php $i = 1;
                        if (mysqli_num_rows($query_barang_keluar) == 0 && isset($_GET["cari"])) { ?>
                            <tr>
                                <td class="center-td" colspan="10">Data Tidak Ditemukan</td>
                            </tr>
                        <?php } else if (mysqli_num_rows($query_barang_keluar) == 0) { ?>
                            <tr>
                                <td class="center-td" colspan="10">Belum Ada Data</td>
                            </tr>
                        <?php }
                        foreach ($query_barang_keluar as $key) { ?>
                            <tr>
